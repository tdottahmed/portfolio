                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="relative">
                            <div className="aspect-square rounded-2xl overflow-hidden shadow-xl">
                                <img 
                                    src={aboutData.image || "https://ui-avatars.com/api/?name=About+Me&background=random"} 
                                    alt="About Me" 
                        ...
                        <div>
                            ...
                            <div 
                                ...
                                dangerouslySetInnerHTML={{ __html: aboutData.bio || "<p>I am a passionate developer...</p>" }}
                            />
                            
                            <div className="grid grid-cols-2 gap-6 mb-8">
                                <div>
                                    <p className="text-sm text-text-secondary mb-1">Name</p>
                                    <p className="font-medium text-text-primary">{aboutData.name || "Tanbir Ahmed"}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-text-secondary mb-1">Email</p>
                                    <p className="font-medium text-text-primary">{aboutData.email || "contact@example.com"}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-text-secondary mb-1">Location</p>
                                    <p className="font-medium text-text-primary">{aboutData.location || "Dhaka, Bangladesh"}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-text-secondary mb-1">Availability</p>
                                    <p className="font-medium text-accent-secondary">Available for work</p>
                                </div>
                            </div>
