        ...
        projects && projects.length > 0
            ...
            : [
                  ...
                  },
                  {
                      ...
                      description:
                          "A collaborative task management tool helping teams stay organized with kanban boards, calendars, and progress tracking.",
                      thumbnail:
                  ...
                  },
                  {
                      ...
                      category: "AI Tool",
                      description:
                          "An AI-powered application that generates high-quality marketing copy, blog posts, and social media captions in seconds.",
                      thumbnail:
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
                ...
                <div className={`flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 sm:gap-0 mb-12 sm:mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <Link
                        ...
                        className="hidden sm:flex items-center px-6 py-3 rounded-full border border-border-subtle hover:border-accent-primary/50 bg-surface-elevated/50 backdrop-blur-sm hover:bg-surface-elevated transition-all duration-300 font-medium text-text-primary group hover:-translate-y-1"
                    >
                        View All Projects{" "}
                        ...
                        return (
                            ...
                            >
                                    ...
                                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4 backdrop-blur-sm">
                                        {projectLinks.live && (
                                            <a
                                                ...
                                                className="p-3 sm:p-4 bg-white rounded-full text-gray-900 hover:bg-accent-primary hover:text-white transition-all duration-300 hover:scale-110"
                                                title="View Live"
                                            >
                                ...
                                <div className="p-6 sm:p-8 flex flex-col flex-grow">
                                    ...
                                    {/* View Project Link */}
                                    <div className="inline-flex items-center gap-2 text-accent-primary hover:text-accent-secondary transition-colors font-semibold text-sm sm:text-base cursor-pointer group/link">
