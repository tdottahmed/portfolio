                ...
                <table className="w-full text-left">
                    <thead className="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Subject/Message</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                        {messages.length > 0 ? (
                            messages.map((message) => (
                                <tr key={message.id} className={`hover:bg-gray-50 ${!message.read_at ? 'bg-blue-50' : ''}`}>
