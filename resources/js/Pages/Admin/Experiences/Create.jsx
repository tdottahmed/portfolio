    ...
    const handleGenerate = async () => {
        ...
        try {
            const response = await axios.post(
                route("admin.experiences.generate"),
                {
            ...
            setData((prev) => ({
                ...
                achievements: generatedData.achievements || prev.achievements,
        ...
        <AdminLayout>
            ...
            <div className="mb-6 flex justify-between items-end">
                ...
                <Button
                    ...
                    disabled={isGenerating || !data.company || !data.position}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="flex items-center pt-6">
                            <input
                                ...
                                onChange={(e) =>
                                    setData("current", e.target.checked)
                                }
